...
Current build: **0.68.0** (2026-08-30). Every release is smoke-tested against the real packaged app before it is kept.

* **0.68.0** THE SAME TILE IN TWO MORE PLACES, AND A FIX HE NEVER RECEIVED. Nick: *"The agents are still doing the same shit and I reset the app."*
* **0.67.0** ELEVEN SESSIONS WERE STANDING ON ONE TILE. Nick, looking at the building with *Connected · 11* in the status bar and two bodies on screen: *"And what are the agents actually doing? They keep running from the rec room to that ledge and are wandering around to where it doesn't make sense. Not really any of the other space is being used."*
